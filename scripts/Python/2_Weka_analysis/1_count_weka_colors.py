...
# Define parameters
input_directory = "/DEFINE DIRECTORY WHERE YOUR IMAGES ANALYZED WITH WEKA ARE LOCATED/"
output_directory = "/DEFINE DIRECTORY WHERE YOU WANT YOUR COLOR-DISSECTED IMAGES TO BE EXPORTED/"
...
final.to_excel(output_directory+'Color_proportions.xlsx', sheet_name='sheet1', index=False)
